                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs">Hoàng Tuấn Nhân</span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            <a href="#">
                                <i class="fa fa-dashboard"></i> <span>Foody</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> List Foody</a></li>
                                <li><a href="index2.html"><i class="fa fa-circle-o"></i> Add Foody</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="list-user"><i class="fa fa-circle-o"></i> List User</a></li>
                                <li><a href="add-user"><i class="fa fa-circle-o"></i> Add User</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="list-cat"><i class="fa fa-circle-o"></i> List Category</a></li>
                                <li><a href="add-cat"><i class="fa fa-circle-o"></i> Add Category</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="list-pages"><i class="fa fa-circle-o"></i> List Pages</a></li>
                                <li><a href="add-pages"><i class="fa fa-circle-o"></i> Add Pages</a></li>
